...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=Montserrat:wght@100;400;500;600&display=swap" rel="stylesheet">
    <link rel='stylesheet' id='custom-style-css' href='http://zornet.ru/Aben/ABGEA/FT/rynud/animations.css' type='text/css' media='all' />
    <link rel="stylesheet" href="css/style.min.css">
    <title>Universe Wedding Dress</title>
</head>
<body> 
    <!-- Не забудь добавить class="fadeIn" -->

    <svg display="none">
        <symbol id="logo-company" viewBox="0 0 1200 186">
    ...
    <svg display="none">
        <symbol id="phone-logo" viewBox="0 0 75.000000 75.000000">
            <g opacity="1" transform="translate(0.000000,75.000000) scale(0.100000,-0.100000)"
            stroke="none">
            <path d="M172 615 c-37 -31 -56 -84 -49 -132 8 -46 73 -156 132 -221 129 -144
            301 -191 382 -104 39 43 29 79 -36 124 -61 42 -94 47 -131 18 l-25 -19 -72 71
            -72 71 20 25 c27 35 24 52 -23 124 -51 74 -78 84 -126 43z m103 -57 c38 -58
            43 -79 20 -98 -30 -25 -16 -54 58 -128 40 -39 81 -72 91 -72 10 0 31 9 47 21
            l30 21 55 -36 c29 -20 54 -43 54 -50 0 -45 -44 -76 -108 -76 -100 0 -263 130
            -335 266 -45 87 -48 130 -11 173 37 44 58 40 99 -21z"/>
            </g>
            </svg>
        </symbol>
    </svg>
    ...
    <svg display="none">
        <symbol id="dress-logo" viewBox="0 0 75.000000 75.000000">
    ...
    <section class="promo" id="promo">
            <div class="promo__wrapper" id="logo-video">
                <video class="promo__wrapper-video" autoplay muted loop src="video/women-bg.mp4"></video>
            </div> <!-- /.promo__wrapper -->
    </section> <!-- /.promo -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-6">
                    <img class="describe__img" data-aos-delay="50"  data-aos-anchor=".describe" data-aos="fade-right" src="img/describe-photo.jpg" alt="describe-photo">
                </div>
                <div class="col-md-12 col-lg-6">
                    <div class="describe__wrapper" data-aos-delay="50"  data-aos-anchor=".describe" data-aos="fade-left">
                        <h3 class="describe__title">Lorem ipsum dolor sit amet, consectetur adipiscing elit</h3>
                        <div class="describe__text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pretium, elit eu faucibus placerat, nibh nulla sagittis ipsum, ut interdum est erat at orci. Proin in tellus sit amet magna mattis pellentesque. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Suspendisse et pellentesque sapien. Donec libero nisi, posuere ut nibh et, ultricies sagittis massa. Vestibulum tincidunt justo id nisl fermentum fermentum. Suspendisse gravida eget est id auctor. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam pretium, elit eu faucibus placerat, nibh nulla sagittis ipsum, ut interdum est erat at orci. Proin in tellus sit amet magna mattis pellentesque. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Suspendisse et pellentesque sapien. Donec libero nisi, posuere ut nibh et, ultricies sagittis massa.  </div>
                    </div>
                </div>
            </div>
        </div> <!-- /.container -->
    ...
    <section class="preview" data-aos-anchor=".preview" data-aos-delay="50" data-aos="fade-up">
        <div class="container-fluid">
            <h3 class="preview__title">New collection "Lorem Ipsum"</h3>
            <div class="preview__slider">
                <div class="preview__slider_wrapper">
                    <div class="preview__slider-item">
                        <img class="preview__slider-img" src="img/slider/slider-1.jpg" alt="">
                        <div class="preview__slider-title">Lorem ipsum</div>
                        <div class="preview__slider-price">499&#8364</div>
                        <div class="preview__slider-buy">
                            <div class="preview__slider-purchase">
                                <div class="preview__slider-purchase_subtitle">Add to cart</div>
                                <img class="preview__slider-purchase_img" src="icons/purchase-buy.svg" alt="">
                            </div>
                            <div class="preview__slider-heart">
                                <div class="preview__slider-heart_subtitle">Add to favorite</div>
                                <img class="preview__slider-heart_img" src="icons/purchase-heart.svg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="preview__slider-item">
                        <img class="preview__slider-img" src="img/slider/slider-2.jpg" alt="">
                        <div class="preview__slider-descr">
                            <div class="preview__slider-title">Lorem ipsum</div>
                            <div class="preview__slider-price">499&#8364</div>
                            <div class="preview__slider-buy">
                                <div class="preview__slider-purchase">
                    ...
                    <div class="preview__slider-item">
                        <img class="preview__slider-img" src="img/slider/slider-3.jpg" alt="">
                        <div class="preview__slider-descr">
                            <div class="preview__slider-title">Lorem ipsum</div>
                            <div class="preview__slider-price">499&#8364</div>
                            <div class="preview__slider-buy">
                    ...
                    <div class="preview__slider-item">
                        <img class="preview__slider-img" src="img/slider/slider-4.jpg" alt="">
                        <div class="preview__slider-descr">
                            <div class="preview__slider-title">Lorem ipsum</div>
                            <div class="preview__slider-price">499&#8364</div>
                            <div class="preview__slider-buy">
                    ...
                    <div class="preview__slider-item">
                        <img class="preview__slider-img" src="img/slider/slider-5.jpg" alt="">
                        <div class="preview__slider-descr">
                            <div class="preview__slider-title">Lorem ipsum</div>
                            <div class="preview__slider-price">499&#8364</div>
                            <div class="preview__slider-buy">
                    ...
                    <div class="preview__slider-item">
                        <img class="preview__slider-img" src="img/slider/slider-6.jpg" alt="">
                        <div class="preview__slider-descr">
                            <div class="preview__slider-title">Lorem ipsum</div>
                            <div class="preview__slider-price">499&#8364</div>
                            <div class="preview__slider-buy">
    ...
    <section class="help">
        <div class="container">
            <h3 class="help__title">How we can help you?</h3>
            <div class="help__inner">
                <div class="row">
                    <div class="col-6">
                        <div class="help__inner-item">
                            <svg class="help__img help__img-phone"><use xlink:href="#phone-logo"></use></svg>
                            <a class="help__btn help__btn-phone" target="_blank" href="https://api.whatsapp.com/send/?phone=380500194819&text=Hello%2C+i+have+a+question+about">Question</a>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="help__inner-item">
                            <svg class="help__img help__img-dress"><use xlink:href="#dress-logo"></use></svg>
                            <button type="button" data-modal="#modalHelp" class="help__btn help__btn-size">Size chart</button>
                        </div>
                    </div>
                </div>
            </div> <!-- /.help__inner -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="footer__copyright">
                            Copyright &copy; Universe Wedding Dress
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="footer__icons">
                            <a class="footer__icons-inst" href=""><img src="icons/footer-instagram.svg" alt="instagram"></img></a>
                            <a class="footer__icons-face" href=""><img src="icons/footer-facebook.svg" alt="facebook"></img></a>
                        </div>
                    </div>
                </div>
            </div> <!-- /.footer__inner -->
        ...
        <div class="modal__inner">
            <div class="modal__content">
                <div class="modal__header">
                    <div class="modal__header-title">Size chart<p></div>
                    <div class="modal__header-text">Here you can determine the size of the wedding dress using table</div>
                </div>
                <div class="modal__size">
                    <table class="sizetable">
                        <thead class="sizetable__header">
                            <tr>
                                <th>Size (EU)</th>
                                <th>Size (USA)</th>
                                <th>Bust (cm)</th>
                        ...
                        <tbody class="sizetable__body">
                            <img class="modal__img" src="img/women-size.png">
                            <tr>
                                <td>34</td>
                                <td>2</td>
                                <td>80</td>
                ...
                <!-- <div class="modal__calc">
                    <form class="form" action="/" id="formSize">
                        <div class="form__group">
                            <input type="text" class="input input--bust" placeholder="Your bust in cm">
                        </div>
                        <div class="form__group">
                            <input type="text" class="input input--waist" placeholder="Your waist in cm">
                        </div>
                        <div class="form__group">
                            <input type="text" class="input input--hips" placeholder="Your hips in cm">
                        </div>
                    </form>
                    <button id="helpBtn" class="help__btn help__btn-size">Check size</button>
                </div> -->
                <div class="modal__footer">
                    <h4 class="modal__footer-title">Need a help?</h4>
                    <a class="help__btn help__btn-phone" target="_blank" href="https://api.whatsapp.com/send/?phone=380500194819&text=Hello%2C+i+have+a+question+about">Send a message with a question</a>
                </div>
                <button class="modal__close" data-modal-close>
                    <img src="icons/close.svg" type="button" alt="close">
                </button>
            </div> <!-- /.modal__content -->
        </div> <!-- /.modal__inner -->
    </div> <!-- /.modal -->
