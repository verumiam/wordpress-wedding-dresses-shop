...
<body>
    ...
    <section class="promo promo-collections" id="promo">
        <div class="promo__wrapper">
            <video class="promo__wrapper-video" autoplay muted loop src="video/one-woman-bg.mp4"></video>
            <h1 class="promo__header">Collections</h1>
        </div> <!-- /.promo__wrapper -->
    </section> <!-- /.promo -->
                ...
                <div class="catalog__wrapper">
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="catalog__item">
                            <a href="collections-1.php"><img src="img/slider/slider-1.jpg" alt="" class="catalog__img"></a>
                            <div class="catalog__title">Collections 1 <p></p></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="catalog__item">
                            <a href=""><img src="img/slider/slider-2.jpg" alt="" class="catalog__img"></a>
                            <div class="catalog__title">Lorem ipsum <p></p></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="catalog__item">
                            <a href=""><img src="img/slider/slider-3.jpg" alt="" class="catalog__img"></a>
                            <div class="catalog__title">Lorem ipsum <p></p></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="catalog__item">
                            <a href=""><img src="img/slider/slider-4.jpg" alt="" class="catalog__img"></a>
                            <div class="catalog__title">Lorem ipsum <p></p></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="catalog__item">
                            <a href=""><img src="img/slider/slider-5.jpg" alt="" class="catalog__img"></a>
                            <div class="catalog__title">Lorem ipsum <p></p></div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                        <div class="catalog__item">
                            <a href=""><img src="img/slider/slider-6.jpg" alt="" class="catalog__img"></a>
                            <div class="catalog__title">Lorem ipsum <p></p></div>
                        </div>
                    </div>
                </div>
    ...
    <!-- <div class="catalog__item">
        <img src="img/slider/slider-3.jpg" alt="" class="catalog__img">
        <div class="catalog__title">Lorem ipsum</div>
        <div class="catalog__price">499&#8364</div>
        <div class="catalog__buy">
            <div class="catalog__purchase">
                <div class="catalog__purchase-subtitle">Add to cart</div>
                <img class="catalog__purchase-img" src="icons/purchase-buy.svg"></img>
            </div>
            <div class="catalog__heart">
                <div class="catalog__heart-subtitle">Add to favorite</div>
                <img class="catalog__heart-img" src="icons/purchase-heart.svg"></img>
            </div>
        </div>
    </div> -->
